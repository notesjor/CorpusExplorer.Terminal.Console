...
{
  public class GetDocumentAllLayersAction : IAddonConsoleAction
  {
    public string Action => "get-document-layers";
    public string Description => "get-document-layer [GUID] {LAYER} - get all layer-information for specific [GUID] document. Use {LAYER} to filter output.";
